...
if ($teacher['status'] !== 'approved') {
    header('Location: /Web-Based%20Health-Integrated%20Student%20Information%20System/templates/teacher/teacher_dashboard.php?error=not_approved');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        header('Location: /Web-Based%20Health-Integrated%20Student%20Information%20System/templates/teacher/my_students.php?success=student_added');
        exit();
        
    } catch (Exception $e) {
        // Rollback transaction on error
        $conn->rollback();
        error_log("Teacher add student error: " . $e->getMessage());
        header('Location: /Web-Based%20Health-Integrated%20Student%20Information%20System/templates/teacher/my_students.php?error=add_failed');
        exit();
    }
} else {
