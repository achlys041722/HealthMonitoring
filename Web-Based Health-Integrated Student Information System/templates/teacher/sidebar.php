...
?>
<nav class="col-lg-2 col-md-3 d-md-block sidebar collapse show" id="sidebarMenu" style="background: linear-gradient(135deg, #ff9a9e 0%, #fecfef 50%, #fecfef 100%); min-height: 100vh; width: 280px; min-width: 280px; flex-shrink: 0;">
    <div class="position-sticky pt-3">
        ...
        <div class="text-center mb-4 px-3">
            ...
            <h6 class="text-white mb-1"><?php echo htmlspecialchars($_SESSION['full_name'] ?? 'Teacher'); ?></h6>
            <small class="text-white-50">Class Teacher</small>
        </div>
        ...
        <ul class="nav flex-column">
            <li class="nav-item mb-2">
                <a class="nav-link d-flex align-items-center px-3 py-3 rounded <?php if($activePage==='dashboard') echo 'active'; ?>" 
                   href="/Web-Based%20Health-Integrated%20Student%20Information%20System/templates/teacher/teacher_dashboard.php"
            ...
            <li class="nav-item mb-2">
                <a class="nav-link d-flex align-items-center px-3 py-3 rounded <?php if($activePage==='notifications') echo 'active'; ?>" 
                   href="/Web-Based%20Health-Integrated%20Student%20Information%20System/templates/teacher/notifications.php"
            ...
            <li class="nav-item mb-2">
                <a class="nav-link d-flex align-items-center px-3 py-3 rounded <?php if($activePage==='my_students') echo 'active'; ?>" 
                   href="/Web-Based%20Health-Integrated%20Student%20Information%20System/templates/teacher/my_students.php"
                   style="color: rgba(255,255,255,0.8); transition: all 0.3s ease; <?php if($activePage==='my_students') echo 'background: rgba(255,255,255,0.2); color: white;'; ?>">
            ...
            <li class="nav-item mb-2">
                <a class="nav-link d-flex align-items-center px-3 py-3 rounded <?php if($activePage==='health_records') echo 'active'; ?>" 
                   href="/Web-Based%20Health-Integrated%20Student%20Information%20System/templates/teacher/health_records.php"
            ...
            <li class="nav-item mb-2">
                <a class="nav-link d-flex align-items-center px-3 py-3 rounded <?php if($activePage==='profile') echo 'active'; ?>" 
                   href="/Web-Based%20Health-Integrated%20Student%20Information%20System/templates/teacher/profile.php"
                   style="color: rgba(255,255,255,0.8); transition: all 0.3s ease; <?php if($activePage==='profile') echo 'background: rgba(255,255,255,0.2); color: white;'; ?>">
...
/* Small adjustment to ensure main content flows properly */
.container-fluid .row {
    display: flex;
    flex-wrap: nowrap;
}
